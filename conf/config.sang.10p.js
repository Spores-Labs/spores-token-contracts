const tesnetBeneficiaries = [
  ...
  // seed sale 100,000,000
  {
    ...
    lockDuration: "0",
    vestingDuration: "10800", // 18 months (30 days as a month) 46656000 seconds,
    vestingInternal: "600", // release vesting per 1 month
  },
  ...
  // private sale 660,000,000
  {
    ...
    lockDuration: "0",
    vestingDuration: "7200", // 12 months (30 days as a month)
    vestingInternal: "600", // release vesting per 1 month
  },
  // ==========================================================================
  ...
  // wallet 1 20% lock 1 year of 50,000,000 10m
  {
    ...
    amount: "10000000", // 10m
    upfrontAmount: "0",
    lockDuration: "14400", // lock 2 years
    vestingDuration: "0",
    vestingInternal: "0",
  },
  //  wallet 2 30% lock 2 years of 50,000,000 15m
  {
    ...
    amount: "15000000", // 15m
    upfrontAmount: "0",
    lockDuration: "21600", // lock 3 years
    vestingDuration: "0",
    vestingInternal: "0",
  },
  // wallet 3 50% lock 3 years of 50,000,000 25m
  {
    ...
    amount: "25000000", // 25m
    upfrontAmount: "0",
    lockDuration: "28800", // lock 4 years
    vestingDuration: "0",
    vestingInternal: "0",
  },
  // ==========================================================================
  ...
  // community 1 200m 4%
  {
    ...
    amount: "200000000",
    upfrontAmount: "0",
    lockDuration: "600", // 1 month = 5 min x 60 = 300s
    vestingDuration: "0",
    vestingInternal: "0",
  },
  // community 2 200m 4%
  {
    ...
    amount: "200000000",
    upfrontAmount: "0",
    lockDuration: "1200", // 2 month = 5 x 60 x 2 = 600s
    vestingDuration: "0",
    vestingInternal: "0",
  },
  // community 3 200m 4%
  {
    ...
    amount: "200000000",
    upfrontAmount: "0",
    lockDuration: "1800", // 3 month = 5 x 60 x 3 = 900s
    vestingDuration: "0",
    vestingInternal: "0",
  },
  // ==========================================================================
  ...
  // ecosystem
  {
    ...
    upfrontAmount: "0",
    lockDuration: "0",
    vestingDuration: "1200", // lock 2 month = 5 min x 60 x 2 = 600s
    vestingInternal: "600", // 1 month = 5 min x 60 = 300s
  },
  {
    address: "0x5771510050A37fA274D1d312062AD5851Bc78512",
    amount: "250000000",
    upfrontAmount: "0",
    lockDuration: "1200", // lock 2 month = 5 min x 60 x 2 = 600s
    vestingDuration: "1200", // 2 month
    vestingInternal: "600", // 1 month
  },
  {
    address: "0x7106C9FEEFa2E5Dbabf4053d2aa898Bde9c6ab17",
    amount: "250000000",
    upfrontAmount: "0",
    lockDuration: "2400", // lock 4 month
    vestingDuration: "1200",
    vestingInternal: "600",
  },
  ...
  // mining
  {
    ...
    upfrontAmount: "0",
    lockDuration: "0",
    vestingDuration: "21600", // 36 months (30 days as a month)
    vestingInternal: "600", // 1 month
  },
  ...
  // reserve
  {
    ...
    amount: "510000000",
    upfrontAmount: "0",
    lockDuration: "5400", // 9 months (30 days as a month)
    vestingDuration: "18000", // 30 months (30 days as a month)
    vestingInternal: "600", // 1 month = 10 x 60
  },
];
